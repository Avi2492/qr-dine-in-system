  ...
  return (
    <div className="relative w-full bg-white shadow-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        <div className="inline-flex items-center space-x-2 font-bold border-2 p-2 rounded-md border-gray-500 cursor-pointer">
          <span>
            SNAP{" "}
            <span className="bg-blue-500 rounded-lg p-1 italic text-white">
              ME
            </span>
          </span>
        </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="inline-flex items-center space-x-2">
                    <span className="font-bold">
                      Scan <span className="bg-blue-500">ME</span>
                    </span>
                  </div>
                  <div className="-mr-2">
                    <button
